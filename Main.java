	...
	public static void main(String[] args) {
		...
		while(total_of_childrens!=0){
			...
			switch(choice)
			{
				...
				System.out.println("DairyMilk\t\t\t"+Diarymilk.price+"\t\t\t"+Diarymilk.quantity+"\t\t\t\t"+Diarymilk.totalprice);
				...
				System.out.println("Gulab Jaamun\t\t\t"+GulabJamun.price+"\t\t\t"+GulabJamun.quantity+"\t\t\t\t"+GulabJamun.totalprice);
		...
		int total_spent_on_gifts=Diarymilk.totalprice+FiveStar.totalprice+Melodies.totalprice+Kheer.totalprice+GulabJamun.totalprice;
